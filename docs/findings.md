...
- **[20/05] Container optimizer objective**: Với bài toán phân bổ nải, mục tiêu vận hành là **số buồng nguyên tối thiểu cần xẻ**, không phải tổng nải-buồng hay kg dư nhỏ nhất. Solver được phép bẻ một dòng đơn hàng thành nhiều khoảng con khi việc đó giảm thiếu hàng hoặc giảm số buồng nguyên cần xẻ. Tuy nhiên số đoạn cắt phải là penalty ngay sau `active_bunches_estimated`; nếu số buồng xẻ không đổi, thuật toán ưu tiên một dải liền kề để tránh lời giải kiểu `1-1` + `2-5` không có lợi về vận hành.
...
- **Chích bắp xảy ra ở cả F0 lẫn Fn** (06/05/2026 — đính chính): Trước đó ghi nhận sai rằng "chích bắp chỉ xảy ra ở F0". Thực tế: F0 dùng hóa chất xúc tiến ra hoa, Fn cây có thể tự ra hoa nhưng vẫn được chích để đồng bộ thời gian thu hoạch. Code vẫn hỗ trợ match Fn — đây là đúng.
