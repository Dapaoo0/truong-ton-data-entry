...
- **[20/05] Container optimizer objective**: Với bài toán phân bổ nải, mục tiêu vận hành là **số buồng nguyên tối thiểu cần xẻ**, không phải tổng nải-buồng hay kg dư nhỏ nhất. Nếu để kg dư/nải-buồng đứng trước, solver có thể tạo lời giải nhìn "khít kg" nhưng vô lý ngoài xưởng, ví dụ tách 27CP thành `1-1` và `2-5`. Fix: hard constraint mỗi dòng chỉ một khoảng nải liền kề; objective sau thiếu thùng là `active_bunches_estimated = max(usage từng nải)`.
