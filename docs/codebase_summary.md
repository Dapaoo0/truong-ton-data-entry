...
- **`container_allocation.py` (Optimizer phân bổ container)**:
  - Chứa cấu hình quy cách mã hàng theo profile: 12 nải dùng `27CP Nhật 1-5`, `30CP Nhật 1-9`, `6H Nhật 5-7`, `5H Nhật 8-10`, `8H Hàn 1-4`, `5/6H Hàn 5-9`, `15CP Hàn 10-12`; 9 nải dùng mapping suy luận theo vùng tương đối.
  - Chứa profile khối lượng nải gốc 12 nải (`28.4kg`) và 9 nải (`19.0kg`); app scale profile về kịch bản `12 nải - 18/20kg` hoặc `9 nải - 12kg` rồi cộng kg từng nải trong dải cắt.
