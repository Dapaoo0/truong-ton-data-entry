...
> Nguồn code chuẩn cho các helper thuần của phần này nằm trong `domain/lifecycle.py`.
> `app.py` chỉ giữ wrapper để giao diện Streamlit hiện tại không bị đổi API nội bộ.
