...
Mục tiêu nghiệp vụ của máy tính này là **tính số buồng nguyên tối thiểu cần xẻ** để đáp ứng đơn hàng theo thị trường/mã hàng. Nguồn buồng nhập vào là giới hạn khả dụng; kết quả `Buồng xẻ tối thiểu` có thể nhỏ hơn nguồn nếu đơn hàng không cần dùng hết sản lượng.
