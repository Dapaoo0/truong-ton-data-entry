...
## [31/05/2026] - Mode Cont -> Số buồng

#### Feature: Tính ngược số buồng xẻ từ cơ cấu container (`container_allocation.py`, `app.py`)
- **[UI]**: Máy tính phân bổ cont có thêm mode `Cont -> Số buồng`; người dùng nhập từng cont riêng với khách hàng, mã hàng và số thùng.
...
- **[Tên mode]**: Đổi 3 nhãn mode thành `Buồng -> Đơn hàng`, `Buồng -> Tối đa cont`, `Cont -> Số buồng` để phân biệt rõ đầu vào/đầu ra.
...
- **[Khách hàng]**: Mode `Buồng -> Đơn hàng` thêm tầng `Khách hàng` (`Wismettac (Nhật 1)`, `Advance (Nhật 2)`, `Uone`) và ưu tiên theo khách hàng trước mã hàng; kết luận vẫn gom theo thị trường vận chuyển Nhật/Hàn.
- **[Blank state]**: Bỏ default đơn hàng/ưu tiên trong mode `Buồng -> Đơn hàng`; người dùng phải chọn khách hàng, mã hàng và nhu cầu trước khi optimizer chạy.
- **[Mục tiêu chính]**: Mode `Buồng -> Đơn hàng` giờ được định nghĩa rõ là tìm `Buồng xẻ tối thiểu`: số buồng nguyên ít nhất cần mở để đáp ứng đơn hàng theo ưu tiên khách hàng/mã hàng.
