...
- Thêm tầng khách hàng cho mode `Buồng -> Đơn hàng`: Wismettac/Advance thuộc Nhật, Uone thuộc Hàn; ưu tiên khách hàng đứng trước ưu tiên mã hàng.
- Bỏ default đơn hàng và ưu tiên trong mode `Buồng -> Đơn hàng`; các dropdown khách hàng/mã hàng/ưu tiên bắt đầu trống.
