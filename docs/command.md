...
- Chuẩn hóa máy tính phân bổ container dùng profile khối lượng từng nải: profile gốc 12 nải tổng 28.4kg và 9 nải tổng 19kg được scale về kịch bản 18/20/15.6kg.
- Đổi công thức optimizer từ chia đều kg/nải sang cộng kg từng nải trong dải cắt sau scale.
- Thêm lựa chọn `Loại buồng` trong UI: 12 nải chọn 18kg/20kg, 9 nải dùng 15.6kg; hiển thị bảng kg từng nải sau quy đổi.
...
- Cập nhật optimizer: ưu tiên thiếu thùng theo khách hàng/mã hàng trước, sau đó tối thiểu `active_bunches_estimated`, số segment, nải-buồng và kg dư.
- Điều chỉnh hàm đánh giá phân bổ nải: không cấm bẻ một dòng đơn hàng, nhưng phạt số segment ngay sau số buồng xẻ tối thiểu để chỉ bẻ khi có lợi thật.
- Cho phép split cùng dòng/mã hàng khi split giúp giảm thiếu hàng hoặc giảm số buồng xẻ; nếu không có lợi về hai mục tiêu đó thì segment penalty giữ phương án một dải liền kề.
- Thêm tầng khách hàng cho mode `Tính số hàng từ số buồng`: Wismettac/Advance thuộc Nhật, Uone thuộc Hàn; ưu tiên khách hàng đứng trước ưu tiên mã hàng.
- Bỏ default đơn hàng và ưu tiên trong mode `Tính số hàng từ số buồng`; các dropdown khách hàng/mã hàng/ưu tiên bắt đầu trống.
...
- Fix bản đồ Farm 157 bị overlap lên section bên dưới trên màn hình lớn: grow-only JS resize + generous fallback height.
- Bỏ làm tròn cột "DT trồng (ha)" trong bảng chi tiết lô (fix guard condition dùng tên cột cũ).
- Thêm số container cho tất cả 4 mốc dự báo (inline trên từng dòng, bỏ footer).
- Thêm caption giải thích ý nghĩa 4 mốc ①②③④ dưới header "Lịch Thu hoạch Dự kiến".
